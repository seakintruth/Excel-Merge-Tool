Attribute VB_Name = "basArrayPearsonFunctions"
Option Explicit
Option Compare Text

' The following Public Functions have been modified from:
...
' VB/VBA arrays.
'
' For details on these Public Functions, see www.cpearson.com/excel/VBAArrays.htm
'
...
'       VectorsToArray
'
' Public Function documentation is in each Public Function.
'
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function ChangeBoundsOfArray(ByRef InputArr As Variant, _
        ByRef NewLowerBound As Long, ByRef NewUpperBound) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ChangeBoundsOfArray
' This Public Function changes the lower and upper bounds of the specified
...
'
' The Public Function returns True if successful, False otherwise.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function CompareArrays(ByRef Array1 As Variant, ByRef Array2 As Variant, _
        ByRef ResultArray As Variant, Optional ByRef CompareMode As VbCompareMethod = vbTextCompare) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CompareArrays
' This Public Function compares two arrays, Array1 and Array2, element by element, and puts the results of
...
Public Function ConcatenateArrays(ByRef ResultArray As Variant, ByRef ArrayToAppend As Variant, _
        Optional ByRef NoCompatabilityCheck As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ConcatenateArrays
' This Public Function appends ArrayToAppend to the end of ResultArray, increasing the size of ResultArray
...
''''''''''''''''''''''''''''''''''''
If IsArrayAllocated(ArrayToAppend) = False Then
...
If IsArrayAllocated(ResultArray) = True Then
...
Public Function CopyArray(ByRef DestinationArray As Variant, ByRef SourceArray As Variant, _
        Optional ByRef NoCompatabilityCheck As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyArray
' This Public Function copies the contents of SourceArray to the DestinationaArray. Both SourceArray
...
'
' The Public Function tests to ensure that the data types of the arrays are the same or are compatible.
' See the Public Function AreDataTypesCompatible for information about compatible data types. To skip
...
''''''''''''''''''''''''''''''''''''
If IsArrayAllocated(SourceArray) = False Then
    CopyArray = True
    Exit Function
End If
...
If NoCompatabilityCheck = False Then
    ...
    ' the Public Function AreDataTypesCompatible
...
Public Function CopyArraySubSetToArray(ByRef InputArray As Variant, ByRef ResultArray As Variant, _
        ByRef FirstElementToCopy As Long, ByRef LastElementToCopy As Long, ByRef DestinationElement As Long) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyArraySubSetToArray
' This Public Function copies elements of InputArray to ResultArray. It takes the elements
...
' enough to copy all the elements, no elements are copied and the Public Function
' returns False.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function CopyNonNothingObjectsToArray(ByRef SourceArray As Variant, _
        ByRef ResultArray As Variant, Optional ByRef NoAlerts As Boolean = False) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' CopyNonNothingObjectsToArray
' This Public Function copies all objects that are not Nothing from SourceArray
...
' procedure.
'
' This Public Function returns True if the operation was successful or False if an
...
' True.
'
' This Public Function uses the following procedures. They are declared as Private
...
Public Function DataTypeOfArray(ByRef Arr As Variant) As VbVarType
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' DataTypeOfArray
'
...
' dimensional, the Public Function returns the data type of the array. Arr
' may be an unallocated array. We can still get the data type of an unallocated
' array.
'
' If Arr is an array of arrays, the Public Function returns vbArray. To retrieve
' the data type of a subarray, pass into the Public Function one of the sub-arrays. E.g.,
' Dim R As VbVarType
' R = DataTypeOfArray(A(LBound(A)))
'
' This Public Function support single and multidimensional arrays. It does not
...
Public Function DeleteArrayElement(ByRef InputArray As Variant, ByRef ElementNumber As Long, _
        Optional ByRef ResizeDynamic As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' DeleteArrayElement
' This Public Function deletes an element from InputArray, and shifts elements that are to the
...
' The Public Function returns True if the elememt was successfully deleted, or False if an error
...
Public Function FirstNonEmptyStringIndexInArray(ByRef InputArray As Variant) As Long
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' FirstNonEmptyStringIndexInArray
...
Public Function InsertElementIntoArray(ByRef InputArray As Variant, ByRef Index As Long, _
        ByRef Value As Variant) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' InsertElementIntoArray
' This Public Function inserts an element with a value of Value into InputArray at locatation Index.
...
If Err.Number <> 0 Then
    ...
    ' size and exit the Public Function.
    '''''''''''''''''''''''''''''''''''''''
    ReDim Preserve InputArray(LBound(InputArray) To UBound(InputArray) - 1)
    Exit Function
End If
...
Public Function IsArrayAllDefault(ByRef InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayAllEmpty
...
Public Function IsArrayAllNumeric(ByRef Arr As Variant, _
        Optional ByRef AllowNumericStrings As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayAllNumeric
' This Public Function returns True is Arr is entirely numeric. False otherwise. The AllowNumericStrings
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayDynamic
' This Public Function returns TRUE or FALSE indicating whether Arr is a dynamic array.
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayEmpty
' This Public Function tests whether the array is empty (unallocated). Returns TRUE or FALSE.
'
' The VBA IsArray Public Function indicates whether a variable is an array, but it does not
' distinguish between allocated and unallocated arrays. It will return TRUE for both
' allocated and unallocated arrays. This Public Function tests whether the array has actually
' been allocated.
'
' This Public Function is really the reverse of IsArrayAllocated.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function IsArrayObjects(ByRef InputArray As Variant, _
        Optional ByRef AllowNothing As Boolean = True) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArrayObjects
...
Public Function IsNumericDataType(ByRef TestVar As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsNumericDataType
'
' This Public Function returns TRUE or FALSE indicating whether the data
...
' TestVar is an array of Variants, the Public Function will indicate only whether
...
' instead of VBA's IsNumeric Public Function because IsNumeric will return
...
Public Function IsVariantArrayConsistent(ByRef Arr As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsVariantArrayConsistent
'
...
' (E.g., Dim V(1 To 3) As Long), the Public Function will return True. If
...
'
' The Public Function does not support arrays of User Defined Types.
'
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function IsVariantArrayNumeric(ByRef TestArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsVariantArrayNumeric
'
' This Public Function return TRUE if all the elements of an array of
...
' As long as they are all numeric data types, the Public Function will
' return TRUE. If a non-numeric data type is encountered, the
' Public Function will return FALSE. Also, it will return FALSE if
' TestArray is not an array, or if TestArray has not been
' allocated. TestArray may be a multi-dimensional array. This
' procedure uses the IsNumericDataType Public Function to determine whether
...
Public Function MoveEmptyStringsToEndOfArray(ByRef InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
' This Public Function uses the following Public Functions, which are included as Private
' procedures at the end of this module.
'       FirstNonEmptyStringIndexInArray
'       NumberOfArrayDimensions
'       IsArrayAllocated
...
Public Function NumberOfArrayDimensions(ByRef Arr As Variant) As Integer
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' NumberOfArrayDimensions
' This Public Function returns the number of dimensions of an array. An unallocated dynamic array
...
Public Function NumElements(ByRef Arr As Variant, Optional ByRef Dimension = 1) As Long
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' NumElements
' Returns the number of elements in the specified dimension (Dimension) of the array in
' Arr. If you omit Dimension, the first dimension is used. The Public Function will return
...
'
' This Public Function does not support arrays of user-defined Type variables.
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function ResetVariantArrayToDefaults(ByRef InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ResetVariantArrayToDefaults
...
' an allocated single-dimensional array. This Public Function differs from the Erase
' Public Function in that it preserves the original data types, while Erase sets every
' element to Empty.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Dim Ndx As Long
'''''''''''''''''''''''''''''''
...
Public Function ReverseArrayInPlace(ByRef InputArray As Variant, _
        Optional ByRef NoAlerts As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ReverseArrayInPlace
...
Public Function ReverseArrayOfObjectsInPlace(ByRef InputArray As Variant, _
        Optional ByRef NoAlerts As Boolean = False) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ReverseArrayOfObjectsInPlace
' This procedure reverses the order of an array in place -- this is, the array variable
...
Public Function SetObjectArrayToNothing(ByRef InputArray As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SetObjectArrrayToNothing
' This sets all the elements of InputArray to Nothing. Use this Public Function
...
Public Function AreDataTypesCompatible(ByRef DestVar As Variant, ByRef SourceVar As Variant) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' AreDataTypesCompatible
' This Public Function determines if SourceVar is compatiable with DestVar. If the two
...
End Function
Public Function VectorsToArray(ByRef Arr As Variant, ParamArray Vectors()) As Boolean
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' VectorsToArray
' This Public Function takes 1 or more single-dimensional arrays and converts
...
End Function
Public Function IsArraySorted(ByRef TestArray As Variant, _
        Optional ByRef Descending As Boolean = False) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' IsArraySorted
' This Public Function determines whether a single-dimensional array is sorted. Because
...
' This Public Function returns True if an array is in sorted order (either ascending or
...
' one dimension, or the VarType of TestArray is not compatible, the Public Function
' returns NULL.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
End Function
Public Function CombineTwoDArrays(ByRef Arr1 As Variant, _
...
End Function
Public Function ExpandArray(ByRef Arr As Variant, ByRef WhichDim As Long, ByRef AdditionalElements As Long, _
        ByRef FillValue As Variant) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' ExpandArray
...
End Function
Public Function SwapArrayRows(ByRef Arr As Variant, ByRef Row1 As Long, ByRef Row2 As Long) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SwapArrayRows
' This Public Function returns an array based on Arr with Row1 and Row2 swapped.
...
Public Function SwapArrayColumns(ByRef Arr As Variant, ByRef Col1 As Long, ByRef Col2 As Long) As Variant
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' SwapArrayColumns
' This Public Function returns an array based on Arr with Col1 and Col2 swapped.
' It returns the result array or NULL if an error occurred.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Dim V As Variant
Dim Result As Variant
...
End Function
Public Function GetColumn(ByRef Arr As Variant, ByRef ResultArr As Variant, ByRef ColumnNumber As Long) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' GetColumn
...
Public Function GetRow(ByRef Arr As Variant, ByRef ResultArr As Variant, ByRef RowNumber As Long) As Boolean
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' GetRow
' This populates ResultArr with a one-dimensional array that is the
